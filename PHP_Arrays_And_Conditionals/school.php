...
if (!$firstName || !$lastName) {
     ...
     if ($finalAverage < .70) {
          ...
          switch ($currentGrade) {
               ...
               break;
               case 10:
               $messageBody = 'Congratulations on completing your sophomore year in High School! We\'ll see you on September 1st for the start of your sophomore year';
               break;
               case 11:
               $messageBody = 'Congratulations on completing your junior year in High School! We\'ll see you on September 1st for the start of your sophomore year';
               break;
               case 12:
               $messageBody = 'Congratulations on completing your senior year in High School! We\'ll see you on September 1st for the start of your sophomore year';
               break;
          }
     }
